...
#==================Frame User code
    button_play_user1=Button(frame_pUser, text="Player1: 'X'", font=('arial',10,'bold') ,width=18,height=1)
    button_play_user1.grid(row=3, columnspan=4,sticky='w')

    button_play_user2=Button(frame_pUser, text="Player2: 'O'", font=('arial',10,'bold') ,width=18,height=1,state=DISABLED)
