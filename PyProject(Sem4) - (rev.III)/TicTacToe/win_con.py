...
def check_draw(keypress_count_user):
    for value in keypress_count_user.values():
        if value==0:
            return False
        elif value==1:
            continue
...
# count=0
def win_cond(terminate,player1,player2,counter,keypress_count_user):
    # global count
...
# check if ANY player has matched with the winning condition.    
            ...
            elif check_draw(keypress_count_user):
            # elif counter%9==0:
